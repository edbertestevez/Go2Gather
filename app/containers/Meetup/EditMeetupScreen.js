...
class EditMeetupScreen extends Component {
				...
				<Content padder style={{flex:1}}>
					<Form>
					    ...
					    <Item style={{width:'90%',height: 45, marginTop:12}}>
			              	...
			              	<TouchableOpacity 
			            	onPress={()=>this.updateLocation(this.props.state.location)}
			            	style={{width:'100%',height:60, borderBottomWidth:1, borderBottomColor:'#cacaca',marginLeft:0,justifyContent:'center',alignItems:'center'}}>
				           		...
				           		<Text style={{fontSize:16}}>{this.state.event_location}</Text>
			            	</TouchableOpacity>
		            	</Item>
...
export default connect(mapStateToProps,mapDispatchToProps)(EditMeetupScreen);